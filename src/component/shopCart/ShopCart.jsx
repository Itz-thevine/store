            ...
            <thead className='mb-5'>
                <tr>
                    ...
                    <th className='text-left text-slate-500 '>
                        <div className='pl-8 md:pl-4'>Quantity</div>
                    </th>
                    <th className='text-left text-slate-500 w-2/12 md:w-auto'>Price</th>
                    <th className='text-left text-slate-500  w-2/12 md:w-auto'>Total</th>
                </tr>
            </thead>
            <tbody>
                <tr className=''>
                    ...
                    <td className=''>
                        <div className='flex flex-col md:flex-row  items-center text-left'>
                            ...
                            <input type="number" className='border-2 my-3 md:my-0 outline-none appearance-none text-center focus:border-green-500 focus:outline-none w-10 mx-3' />
